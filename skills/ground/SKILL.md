---
name: ground
description: "Read the project's knowledge record before answering from memory. Use before answering about the project's state, a number, a date, a decision, a source or what was agreed; before changing a value the record may hold; and whenever the session opener or a grounding line names entries. Runs pull, affects and check, reads what hypotheses and other branches propose, and searches when a question maps to no name. A missing id is not absence."
---
