...
def parser():
    result = argparse.ArgumentParser(prog="kpop experimental annotated-doc", description="Annotated Documents: experimental application for standalone HTML with evidence.")
