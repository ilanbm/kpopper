...
Release bundles include the compiled HTML runtime, or use the [plugin application setup](applications.md#installation-and-use). Request
...
The [author guide](../native/src/annotated_document_guide.md) describes exact source selectors,
...
The package carries this runtime. The npm package continues to provide the existing
