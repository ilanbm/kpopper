...
independent worker. Routine completion emits no hook output. Important results enter the next
...
be validated in the actual client before claiming support beyond the documented Codex hook
contract.
